...
def build_losses(config, num_train_clothes):
    ...
    # recon_uncloth = nn.MSELoss()
    # recon_contour = nn.MSELoss()
    # recon_cloth = nn.MSELoss()

    recon_uncloth = nn.SmoothL1Loss()
    recon_contour = nn.SmoothL1Loss()
    recon_cloth = nn.SmoothL1Loss()
