...
class GEN(nn.Module):
    def __init__(self, in_feat_dim, out_img_dim, device, config, **kwargs, ):
        ...
        self.conv0 = DeformConv2d(in_feat_dim, 64, stride=1, padding=1)
        self.conv1 = DeformConv2d(64, 64, stride=1, padding=1)
        self.conv2 = DeformConv2d(64, 32, stride=1, padding=1)
        self.conv3 = DeformConv2d(32, 32, stride=1, padding=1)
        self.conv4 = DeformConv2d(32, out_img_dim, stride=1, padding=1)
