# coding=utf-8
# @FileName:img_resnet_578_tfd.py
# @Time:2023/10/22 
# @Author: CZH
...
class GEN(nn.Module):
    def __init__(self, in_feat_dim, out_img_dim, config, **kwargs, ):
        ...
        #     if_offset=True,
        #     device=device)
        # self.conv4 = DSConv_pro(
        #     in_channels=32,
        #     out_channels=out_img_dim,
        #     kernel_size=5,
        #     extend_scope=1,
        #     morph=0,
        #     if_offset=True,
...
class ResNet50(nn.Module):
    ...
    def forward(self, x):
        ...
        tfd1 = self.TFD1(self.channel1024to3(f_cont), self.channel1024to3(f_cont_sftca))

        # print("f_unclo.shape:", f_unclo.shape) # 1024
        # print("f_cont.shape:", f_cont.shape) # 1024
        # print("f_clo.shape:", f_clo.shape) # 512
        ...
        # print("tfd1.shape", tfd1.shape)
        tfd2 = self.TFD2(tfd1, self.channel1024to3(conv_x_2))
        ...
        # print("tfd2.shape", tfd2.shape)
        tfd3 = self.TFD3(tfd2, self.channel1024to3(f_cont_map))
        f_cont_map = self.TFD4(self.channel1024to3(f_cont_map), tfd3)

        f_unclo_map = self.proj_drop_1(f_unclo_map)
        f_cont_map = self.proj_drop_2(self.channel3to1024(f_cont_map))
